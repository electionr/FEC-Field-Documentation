...
class Records(fechbase.RecordsBase):
    def __init__(self):
        ...
        self.fields = [
            ...
            {'name': 'Transfers from other auth cmtes', 'number': '13-(f) 12.'},
            ...
            {'name': 'Transfers to other auth cmtes', 'number': '21-(n) 18.'},
            ...
            {'name': 'Refunds Political Pty cmtes', 'number': '26-(s) 20(b)'},
            {'name': 'Refunds other Polit. cmtes', 'number': '27-(t) 20(c)'},
