...
class Records(fechbase.RecordsBase):
    def __init__(self):
        ...
        self.fields = [
            ...
            {'name': 'DISSEMINATION DATE', 'number': '20'},
            {'name': 'EXPENDITURE AMOUNT', 'number': '21'},
            {'name': 'DISBURSEMENT DATE', 'number': '22'},
            {'name': 'CALENDAR Y-T-D (per election/office)', 'number': '23'},
            {'name': 'EXPENDITURE PURPOSE DESCRIP', 'number': '24'},
            {'name': 'CATEGORY CODE', 'number': '25'},
            {'name': 'PAYEE CMTTE FEC ID NUMBER', 'number': '26'},
            ...
            {'name': 'S/O CANDIDATE STATE', 'number': '36'},
