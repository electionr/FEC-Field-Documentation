...
class Records(fechbase.RecordsBase):
    def __init__(self):
        ...
        self.fields = [
            ...
            {'name': 'HSE/SEN PTY CMTES', 'number': '4'},
            {'name': 'HSE/SEN PTY CMTES PERCENTAGE', 'number': '5'},
            {'name': 'HSE/SEN PTY CMTES PERCENTAGE', 'number': '6'},
            {'name': 'HSE/SEN PTY CMTES', 'number': '7'},
            {'name': 'HSE/SEN PTY CMTES', 'number': '8'},
            {'name': 'HSE/SEN PTY CMTES PERCENTAGE', 'number': '9'},
